...
public interface FridgeRepository extends JpaRepository<Fridge, Integer> {
    ...
    List<FridgeSpending> spendingMoneyForEveryFridge(@Param("priceForElectricity") float priceForElectricity, @Param("nameCompany") String nameCompany);
    ...
    float spendingMoneyAllFridges(@Param("priceForElectricity") float priceForElectricity, @Param("nameCompany") String nameCompany);
}
